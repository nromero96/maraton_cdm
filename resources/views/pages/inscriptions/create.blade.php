                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area pt-0">
                        <form class="row g-3" action="{{ route('inscriptions.store') }}" method="POST" id="formInscription" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-4">
                                <label for="inputName" class="form-label fw-bold">{{__("Nombre completo")}}:</label>
                            ...
                            <div class="col-md-12">
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($category_inscriptions as $category)
                                                @php
                                                    if($category->name == 'Dermatólogos - Pediatras' || $category->name == 'Residentes' || $category->name == 'Cuota especial'){
                                                ...
                                                @if($beneficiariobeca == 'si' && $category->status == 'active')
                                                    <tr>
                                                        <td>
                                ...
                                <div id="dv_accompanist" class="d-none">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <label for="accompanist_solapin" class="text-muted">{{__("Solapín")}}:</label>
