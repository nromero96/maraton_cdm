                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area pt-0">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label fw-bold mb-0">{{__("Solapín")}}:</label><br>
                                    ...
                                    <div id="dv_accompanist" class="@if ($inscription->accompanist_id != null || $inscription->accompanist_name != '') @else d-none @endif">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="accompanist_name" class="form-control" id="accompanist_name" value="{{ $inscription->accompanist_name }}" placeholder="Nombre completo">
                                            </div>
                                            <div class="col-md-3">
