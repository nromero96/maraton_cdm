                        ...
                        <form class="row g-3" action="{{ route('users.updatemyprofile') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="w-50">
                                        <input type="number" name="phone_number" class="form-control rounded-0 rounded-end" id="inputPhoneNumber" value="{{$user->phone_number}}" placeholder="" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="w-75">
                                        <input type="number" name="whatsapp_number" class="form-control rounded-0 rounded-end" id="inputPhoneNumber" value="{{$user->whatsapp_number}}" placeholder="" required>
                                        <small>{{ __('Número') }}</small>
                                    </div>
                                </div>
