...
<body>
    <div class="container">
        ...
        <p><a href="https://viimaraton2024.cidermperu.org/">Ver Proceso de Inscripción</a></p>
        ...
        <!-- Contacto de soporte -->
        <p>Estamos aquí para ayudarle en caso de cualquier consulta o aclaración adicional. Para mayores detalles, puede contactarse con nosotros a través del e-mail <b>inscripciones@rosmarasociados.com</b></p><br>

        <!-- Firma y contacto del Comité Organizador -->
        <p class="signature">Atentamente,<br>Comité Organizador<br><b>VII Maratón 2024</b><br>+51 983 481 269<br>inscripciones@rosmarasociados.com</p>
    </div>
</body>
</html>