...
class UserController extends Controller
{
    ...
    public function updatemyprofile(Request $request){
        ...
        //si es todo correcto redirigir a la vista de inscripción
        return redirect()->route('inscriptions.create')->with('success', '¡Datos registrados correctamente, ahora puedes inscribirte!');
