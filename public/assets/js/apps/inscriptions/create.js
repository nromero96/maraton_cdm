document.addEventListener("DOMContentLoaded", function () {
    ...
    function validarCamposInscription() {
        ...
        if(selectedRadioCategoryInscription.value === '3' && document.getElementById('specialcode_verify').value === ''){
...
const txtPriceSpecialCode = document.getElementById('dc_price_3');
...
function handleCategoryRadioButtons(){
    ...
    if(selectedValueCategory === '1' || selectedValueCategory === '2'){
      ...
      } else if(selectedValueCategory === '3'){
    ...
    const radioCategory = document.getElementById('category_3');
